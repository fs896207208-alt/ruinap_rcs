 ...
 */
public interface IBaseServerHandler {
     ...
     * @param evt 事件对象
     */
    JSONObject userEventTriggered(ChannelHandlerContext ctx, Object evt, ServerAttribute attribute);
     ...
     * @param frame 数据帧
     */
    void channelRead0(ChannelHandlerContext ctx, Object frame, ServerAttribute attribute);
     ...
     * @param cause 异常
     */
    void exceptionCaught(ChannelHandlerContext ctx, Throwable cause, ServerAttribute attribute);
}
