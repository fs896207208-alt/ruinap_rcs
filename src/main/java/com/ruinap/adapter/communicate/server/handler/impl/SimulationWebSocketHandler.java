...
import com.slamopto.communicate.event.SimulationWebSocketEvent;
...
/**
 * 仿真服务器类，用于处理 WebSocket 业务相关的消息
 *
 * @author qianye
 * @create 2025-05-19 21:25
 */
@ChannelHandler.Sharable
public class SimulationWebSocketHandler implements IServerHandler {
        ...
        if (frame instanceof TextWebSocketFrame) {
            ...
            try {
                ...
                if (!jsonObject.isEmpty()) {
                    // 处理事件
                    SimulationWebSocketEvent.receiveMessage(serverId, jsonObject);
                } else {
    ...
    public JSONObject userEventTriggered(ChannelHandlerContext ctx, Object evt, ServerAttribute attribute) {
        ...
        if (evt instanceof WebSocketServerProtocolHandler.HandshakeComplete) {
            ...
            if (NettyServer.getCONTEXTS().containsKey(serverId)) {
                ...
                ctx.writeAndFlush(new TextWebSocketFrame("Simulation服务端【" + serverId + "】连接成功，欢迎使用调度系统仿真服务器"));
