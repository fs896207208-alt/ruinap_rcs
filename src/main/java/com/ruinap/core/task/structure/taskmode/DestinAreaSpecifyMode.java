 ...
 */
@Component
public class DestinAreaSpecifyMode implements TaskModeHandle {
    @Autowired
    ...
    public RcsAgv handle(RcsTask rcsTask) {
        ...
        //获取任务终点区域指定AGV
        Map<String, String> taskDestinSpecify = taskCommon.getTaskDestinArea();
        ...
        //根据点位区域获取相关AGV的字符串表示
        String agvStr = taskDestinSpecify.get(destinPoint.getAreaCode());
