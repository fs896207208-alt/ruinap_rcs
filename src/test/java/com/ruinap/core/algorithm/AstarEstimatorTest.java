...
import com.ruinap.core.algorithm.search.AstarEstimator;
...
public class AstarEstimatorTest {

    private Digraph<RcsPoint, RcsPointTarget> graph;
    private AstarEstimator estimator;
    ...
    public void setUp() {
        ...
        // 3. 实例化估值器
        estimator = new AstarEstimator(graph);
    }
    ...
    public void testFactoryMethod() {
        ...
        AstarEstimator instance = new AstarEstimator(mapSnapshot.graph());
